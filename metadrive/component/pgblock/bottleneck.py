...
class Merge(Bottleneck):
    ...
    def _try_plug_into_previous_block(self) -> bool:
        ...
        center_line_type = PGLineType.CONTINUOUS if parameters[
            "solid_center_line"] else PGLineType.BROKEN
        ...
        no_cross = CreateRoadFrom(ref_lane,
                                  ...
                                  side_lane_line_type=PGLineType.SIDE if
                                  circular_lane_num == 0 else PGLineType.NONE,
        ...
        no_cross = CreateAdverseRoad(
            ...
            if circular_lane_num == 0 else PGLineType.NONE,
            center_line_type=center_line_type,
        ...
        for index, lane in enumerate(self.positive_lanes[straight_lane_num:],
            ...
            no_cross = CreateRoadFrom(circular_1,
                                      1,
                                      road_1,
                                      self.block_network,
                                      self._global_network,
            ...
            no_cross = CreateRoadFrom(circular_2,
                                      1,
                                      road_2,
                                      self.block_network,
                                      self._global_network,
    ...
    def _try_plug_into_previous_block(self) -> bool:
        ...
        for index in range(1, circular_lane_num + 1):
            ...
            circular_1, circular_2, straight = create_wave_lanes(
                lane, lateral_dist, self.BOTTLENECK_LEN,
                parameters[Parameter.length], self.lane_width, False)
        ...
        # extend for socket ,part 1 road 1
        socket_road = Road(self.road_node(0, 0), self.road_node(0, 1))
        no_cross = CreateRoadFrom(socket_road_ref_lane,
                                  total_num,
                                  socket_road,
                                  self.block_network,
                                  self._global_network,
