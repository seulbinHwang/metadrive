...
from metadrive import (MultiAgentMetaDrive, MultiAgentTollgateEnv,
                       MultiAgentBottleneckEnv, MultiAgentIntersectionEnv,
...
if __name__ == "__main__":
    ...
    try:
        ...
        )  # Default is in Top-down view, we switch to Third-person view.
                ...
                **extra_args,
                ...
                text={
                    ...
                    "Number of existing vehicles":
                        len(env.agents),
                    "Tracked agent (Press Q)":
                        env.engine.agent_manager.object_to_agent(
                            env.current_track_agent.id),
                    "Keyboard Control":
                        "W,A,S,D",
