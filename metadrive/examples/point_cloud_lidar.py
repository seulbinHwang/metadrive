    ...
    try:
        env = ScenarioEnv({
            ...
            "image_observation":
                True,
            "vehicle_config":
                dict(image_source="point_cloud"),
            "sensors":
                dict(point_cloud=(PointCloudLidar, 200, 64, True)
                    ),  # 64 channel lidar
            "data_directory":
        ...
        for i in range(1, 100000):
            ...
            points = o["image"][..., :, -1] + np.asarray(
                env.engine.render.get_relative_point(cam, Point3(0, 0, 0)))
